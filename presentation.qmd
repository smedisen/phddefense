...
:::
::: {.column .v-center}
* Exploration in several *linked* visualizations
...
* Filtered rules describe the DMs preferences
:::
::::
:::
...
::: {.column }
* *Knowledge discovery*
  * Investigate further knowledge representations
...
::: {.column .fragment .fade-in}
* *Mimer*
  * Incorporate additional knowledge discovery methods
  * No-preference, knee-point detection
  * Develop compatibility with existing optimization platforms (pymoo, DESDEO)

:::
::: {.column .fragment .fade-in}
* *KDO*
  * Develop more knowledge-driven operators
  * Interactive KDO
  * Algorithms centered around knowledge, knowledge-based metaphors to drive the search
:::
::::
:::
