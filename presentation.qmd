...
<ul>
  <li style="list-style-type: none">
    <Ul>
      ...
      <li>Can *not* be diectrly applied without further interpretation</li>
...
<ul>
  <li style="list-style-type: none">
    <Ul>
      ...
      <li>Can be transferred between processees</li>
...
* Trend Mining
  * <span style="width: 150%; display: block;">Find if *variables* follow a trend in the *objective space*</span>
...
* Influence Score
  ...
  * Applied to an industiral use-case
...
![](figures\kdoflow.drawio.svg){style="width: 85%; margin-left: 2vw;"}
